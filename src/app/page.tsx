...
export default function Home() {
  ...
  return (
    <div className="space-y-10">
      {/* 배너 — 토스 스타일 깔끔한 카드 */}
      <section>
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-800 dark:via-gray-850 dark:to-gray-900 p-8 md:p-12 shadow-sm border border-amber-100/50 dark:border-gray-700/50">
          <div className="relative z-10">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-3 font-[family-name:var(--font-jua)]">
              우리 애 자랑하러 오세요!
            </h1>
      ...
      <section>
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold font-[family-name:var(--font-jua)] text-gray-900 dark:text-white">이주의 멍냥</h2>
          <Link href="/ranking" className="text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
            전체보기 →
          </Link>
        </div>
        {popularPosts.length > 0 ? (
          ...
          <div className="text-center py-14 text-gray-400 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-900 dark:text-white">자유게시판 최신 글</h3>
              <Link href="/board" className="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                더보기
              </Link>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span className="text-xs text-gray-300 dark:text-gray-600 flex-shrink-0">2분 전</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <span className="text-gray-300 dark:text-gray-600">📝</span>
                <span className="truncate">강아지 사료 추천 부탁드려요!</span>
                <span className="text-xs text-gray-300 dark:text-gray-600 flex-shrink-0">15분 전</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <span className="text-gray-300 dark:text-gray-600">📝</span>
                <span className="truncate">고양이 장난감 뭐가 좋을까요</span>
                <span className="text-xs text-gray-300 dark:text-gray-600 flex-shrink-0">1시간 전</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-900 dark:text-white">공지사항</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <span className="text-amber-400">📢</span>
                <span className="truncate">집사모여 서비스 오픈 안내</span>
                <span className="text-xs text-gray-300 dark:text-gray-600 flex-shrink-0">2026.04.14</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <span className="text-amber-400">📢</span>
      ...
      <section>
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold font-[family-name:var(--font-jua)] text-gray-900 dark:text-white">최신 게시글</h2>
        </div>
