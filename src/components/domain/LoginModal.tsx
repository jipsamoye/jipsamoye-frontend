    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          {/* 구글 로그인 — 버튼만, 동작 안 함 */}
          <button className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium text-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200">
