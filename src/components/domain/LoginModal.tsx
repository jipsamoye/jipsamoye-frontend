    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="text-center">
        ...
        <div className="flex flex-col gap-3">
          {/* 카카오 로그인 — 버튼만, 동작 안 함 */}
          <button className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-[#FEE500] text-[#191919] font-medium text-sm hover:bg-[#FDD800] transition-colors">
          ...
          {/* 구글 로그인 — 버튼만, 동작 안 함 */}
          <button className="flex items-center justify-center gap-2 w-full py-3 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium text-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white dark:bg-gray-900 text-gray-400">또는</span>
            </div>
          </div>
